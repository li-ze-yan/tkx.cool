...
import { SafeZone, StaggerText } from "~/components";
      ...
      <section>
        ...
        >
          <motion.button
            ...
            whileHover="shake"
            whileTap={["push", "shake"]}
            className="inline-flex justify-center rounded-lg font-semibold lg:py-3 py-2 lg:px-4 px-3 bg-slate-900 text-white hover:bg-slate-700 transition-all duration-300 ease-linear"
          ...
          <motion.button
            ...
            className="inline-flex justify-center rounded-lg text-sm font-semibold lg:py-3 py-2 lg:px-4 px-3 bg-white/0 text-slate-900 ring-1 ring-slate-900/10 hover:bg-white/25 hover:ring-slate-900/15 transition-all duration-300 ease-linear"
      ...
      >
        <div className="flex justify-between items-center">
          <motion.ul
            ...
            animate="show"
            initial="hidden"
            className="flex lg:gap-2 gap-1 group"
          >
        ...
        <motion.div
          ...
          className="w-full lg:flex hidden lg:gap-2 gap-0 shadow-rounded p-2 sm:p-4 md:p-12 bg-transparent rounded-xl mt-6"
        >
          {/* left */}
          <div className="lg:w-2/5 w-0 pt-28 pb-40">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-[#13547a] to-[#80d0c7] tracking-widest my-8 "
            >
              以卓越之力量散发深远的影响
            </motion.p>
            <p className="text-sm tracking-widest text-[#787878]">
              <StaggerText
                ...
                y={0}
                text="打造一个属于自己的独特网站，是一次充满创意与潜力的冒险，网站不仅仅是一个虚拟的存在，更是你自我表达和展示的窗口，一个数字化的身份证明，也是一个展示你的影响力和专业能力的平台，通过在网站上提供有价值的内容，你可以吸引更多的人关注你的领域，建立起你在该领域的声誉和影响力，总之，打造一个属于自己的网站是一个有趣且具有潜力的项目，它不仅可以让你实现自我表达，还可以成为展示你的独特价值和影响力的强大工具。精心设计和管理你的网站，将为你的个人和职业生涯带来更多机会和成就！"
              />
            </p>
          </div>
          {/* right */}
          <div className="lg:w-3/5 w-full flex justify-center items-center lg:text-base text-sm">
            <div className="w-full h-5/6">
              <motion.div
                ...
                viewport={{ once: true }}
                className="w-full border-2 border-[#f0f0f0] border-solid rounded-lg shadow-rounded px-4 py-3 flex items-center"
              >
